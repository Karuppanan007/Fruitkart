    ...
    return (
        <div className="p-6 pt-20">
            ...
            <div className="max-w-2xl mx-auto space-y-6">
                ...
                {/* Order Note */}
                <div className="bg-white p-4 rounded-lg shadow-md">
                    <h2 className="font-semibold text-lg flex items-center gap-2"> <span className="bg-green-500 px-2 mt-1 text-white rounded-full text-[25px]">
                        3
                    </span>Message</h2>
                    <textarea placeholder="Enter your message" className="mt-2 w-full p-2 border rounded-md"></textarea>
                </div>
