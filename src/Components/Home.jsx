    ...
    <>
      <div id='home' className='relative w-full h-screen flex flex-col items-center justify-center'>
        ...
        <div className='absolute inset-0 flex flex-col items-center justify-center text-white bg-black bg-opacity-50 text-center p-4'>
          <h1 className='text-8xl sm:text-5xl font-bold '>
          ...
          <div className='relative w-full max-w-md mt-2'>
            ...
            />
            <a href="#fruits"><button className='absolute right-0.5 top-1/2 transform -translate-y-1/2 text-white bg-green-600 px-3 py-[12px] rounded-md hover:bg-green-700'>
              <FaSearch size={20} />
            </button></a>
          </div>
        </div>
